    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card-body">
                ...
                {!! Form::open(array('route' => 'admin.data.get_data', 'id' => 'admin.activity.view_users')) !!}
        <div class="row mb-3">
        ...
        <div class="row mb-3">
            <label for="inputEmail" class="col-sm-2 col-form-label">Date From</label>
            <div class="col-sm-4">
            <input type="text" name="date_from" id="zdate" class="zdate form-control">
            </div>

            <label for="inputEmail" class="col-sm-1 col-form-label">Date To</label>
            <div class="col-sm-4">
            <input type="text" name="date_to" id="zdate" class="zdate form-control">
            </div>
        </div>
