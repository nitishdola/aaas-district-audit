                ...
                <div class="row">
                    ...
                    <!-- <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::select('district_id', $districts, null, ['class' => 'form-control select2 col-md-12', 'placeholder' => 'Select District', 'id' => 'district_id']) !!}
                        </div>
                    </div> -->
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>{{ $k+1 }}</td>
                                    <td>
                                        <a href="{{ route('audit.beneficiary.view_home_visit', Crypt::encrypt($v->id)) }}">
